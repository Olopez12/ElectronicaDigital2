...
unsigned char UART_read(void);				// Lectura del USART
void UART_write(unsigned char);				// Escritura de caracteres 
void UART_init(void);						// Inicialización del USART
void UART_write_txt(char*);						// Escritura de texto 
